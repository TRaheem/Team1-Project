...
namespace WorkShop2
{
	...
	public partial class TravelExpertDBDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void InsertPackage_Product(Package_Product instance);
    partial void UpdatePackage_Product(Package_Product instance);
    partial void DeletePackage_Product(Package_Product instance);
    #endregion
		
		public TravelExpertDBDataContext() : 
				base(global::WorkShop2.Properties.Settings.Default.TravelExpertsConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public TravelExpertDBDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public TravelExpertDBDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public TravelExpertDBDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public TravelExpertDBDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<Package_Product> Package_Products
		{
			get
			{
				return this.GetTable<Package_Product>();
			}
		}
	}
	...
	public partial class Package : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<Package_Product> _Package_Products;
    ...
    partial void OnPkgAgencyCommissionChanged();
		...
		public Package()
		{
			...
			this._Package_Products = new EntitySet<Package_Product>(new Action<Package_Product>(this.attach_Package_Products), new Action<Package_Product>(this.detach_Package_Products));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Package_Package_Product", Storage="_Package_Products", ThisKey="PackageId", OtherKey="PackageID")]
		public EntitySet<Package_Product> Package_Products
		{
			get
			{
				return this._Package_Products;
			}
			set
			{
				this._Package_Products.Assign(value);
			}
		}
		...
		private void attach_Package_Products(Package_Product entity)
		{
			this.SendPropertyChanging();
			entity.Package = this;
		}
		
		private void detach_Package_Products(Package_Product entity)
		{
			this.SendPropertyChanging();
			entity.Package = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Package_Products")]
	public partial class Package_Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnPackageNameChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Package_Package_Product", Storage="_Package", ThisKey="PackageID", OtherKey="PackageId", IsForeignKey=true)]
		public Package Package
		{
			get
			{
			...
			set
			{
							...
							|| (this._Package.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Package.Entity = null;
						previousValue.Package_Products.Remove(this);
					}
					this._Package.Entity = value;
					if ((value != null))
					{
						value.Package_Products.Add(this);
						this._PackageID = value.PackageId;
					}
					else
					{
